...
<head>
    ...
    <title>用户登录 - Powered by QingwuWIKI</title>     <!--Qingwu Add-->     <link href="/static/images/favicon.ico" mce_href="favicon.ico" rel="icon" type="image/x-icon">
...
<br><br><br>
<div id="title_div"><center><h1>OGD Spider-政府数据开放平台数据监测系统软件</h1></center></div>
    ...
    <div class="row login">
        <div class="login-body">
            <form role="form" method="post">
                ...
                <div class="checkbox">
                    &nbsp;&nbsp;
                    <a href="{{urlfor "AccountController.FindPassword" }}" style="display: inline-block;float: right">新用户注册</a>
                    &nbsp;&nbsp;
                </div>
                <div class="form-group">
