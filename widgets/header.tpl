            ...
            <nav class="collapse navbar-collapse col-sm-10">
                <ul class="nav navbar-nav">
                    ...
                    <li {{if eq .ControllerName "QingwuController"}}{{if eq  .ActionName "List" "Index"}}class="active"{{end}}{{end}}>
                        <a href="http://heaven" title="清无时空">L</a>
                    </li>
                </ul>
                ...
                <a href="javascript:void(0)" class="navbar-brand" title="QuickLinks"
                    id="btn_quick_links" style="font-size:1.2em;
                    margin-left:0.1px;
                    color:gold;
                    background-color:gray;">
                                <b>L</b>
                </a>
                <a href="{{urlfor "QingwuController.List" }}" class="navbar-brand" title="最近"
